...
const SideBar = ({sideBar=false}) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed top-16 left-0 bg-gray-600 text-white w-44 h-screen p-5 space-y-6 transition-transform ${isOpen ? "translate-x-0" : "-translate-x-full"} md:block z-40 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 z-150`}>
        <nav>
